    ...
    internal class InvoiceMapper : IMapper<Api.Invoice, Invoice>
    {
        ...
        public Api.Invoice DomainToApi(Invoice value)
        {
            ...
            return new Api.Invoice
            {
                ...
                InvoiceNumber = value.InvoiceNumber,
                Number = value.Number == 0 || value.Number == null ? null : value.Number.ToString(),
                NumberPre = value.NumberPre == "" || value.NumberPre == null ? null : value.NumberPre,
                NumberLength = value.NumberLength == 0 ? null : value.NumberLength.ToString(),
                Title = value.Title,
